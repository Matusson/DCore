...
namespace DCore.Configs.Tests
{
    ...
    public class BotConfigTests
    {
        ...
        public void CreateNew()
        {
            ...
            var bot = manager.CreateBots(1, typeof(GlobalBotConfig)).FirstOrDefault();
        ...
        public void LoadExisting()
        {
            ...
            var bot = manager.CreateBots(1).FirstOrDefault();
            bot.Dispose();

            manager.ConfigManager.GlobalBotConfig.DefaultBotConfig.Prefix = "!";
            bot = manager.CreateBots(1).FirstOrDefault(); //restart the bot to re-fetch the config
        ...
        public void LoadExisting_Extensions()
        {
            ...
            bot = manager.CreateBots(1, typeof(GlobalBotConfig)).FirstOrDefault(); //restart the bot to re-fetch the config
